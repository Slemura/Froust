...
namespace Cysharp.Threading.Tasks
{
        ...
        IPromise
    {
        ...
        public UniTask Task
        {
            [DebuggerHidden] get => new UniTask(this, core.Version);
        }
        ...
        ITaskPoolNode<AutoResetUniTaskCompletionSource<T>>, IPromise<T>
    {
        ...
        {
            [DebuggerHidden] get => new UniTask<T>(this, core.Version);
        }
    ...
    public class UniTaskCompletionSource : IUniTaskSource, IPromise
    {
        ...
        public UniTask Task
        {
            [DebuggerHidden] get => new UniTask(this, 0);
        }
    ...
    public class UniTaskCompletionSource<T> : IUniTaskSource<T>, IPromise<T>
    {
        ...
        public UniTask<T> Task
        {
            [DebuggerHidden] get => new UniTask<T>(this, 0);
        }
